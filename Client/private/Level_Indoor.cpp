...
{
	SPAWN_SHOTGUNNER(888.f, 50.f, 845.f, LEVEL_INDOOR, true);
	SPAWN_NUKEMUTANT(717.f, 50.f, 511.f, LEVEL_INDOOR, true);
	SPAWN_SHOTGUNNER(718.f, 50.f, 591.f, LEVEL_INDOOR, true);
	SPAWN_SHOTGUNNER(719.f, 50.f, 671.f, LEVEL_INDOOR, true);

	SPAWN_SHOTGUNNER(1124.f, 50.f, 330.f, LEVEL_INDOOR, true);
	SPAWN_SHOTGUNNER(1110.f, 50.f, 700.f, LEVEL_INDOOR, true);
	SPAWN_NUKEMUTANT(1434.f, 50.f, 550.f, LEVEL_INDOOR, true);
	SPAWN_NUKEMUTANT(1565.f, 50.f, 800.f, LEVEL_INDOOR, true);
							 
	SPAWN_NUKEMUTANT(1667.f, 50.f, 320.f, LEVEL_INDOOR, true);
	SPAWN_NUKEMUTANT(2100.f, 50.f, 545.f, LEVEL_INDOOR, true);
	SPAWN_NUKEMUTANT(1663.f, 50.f, 993.f, LEVEL_INDOOR, true);
	SPAWN_NUKEMUTANT(2180.f, 50.f, 846.f, LEVEL_INDOOR, true);
	SPAWN_NUKEMUTANT(1980.f, 50.f, 800.f, LEVEL_INDOOR, true);
	SPAWN_SHOTGUNNER(2140.f, 50.f, 912.f, LEVEL_INDOOR, true);
