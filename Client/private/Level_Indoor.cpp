...
{
	SPAWN_NUKEMUTANT(630.f, 200.f, 425.f, LEVEL_INDOOR);
	SPAWN_NUKEMUTANT(613.f, 200.f, 425.f, LEVEL_INDOOR);
	SPAWN_MECHSECT(680.f, 200.f, 525.f, LEVEL_INDOOR);
	SPAWN_MECHSECT(640.f, 200.f, 525.f, LEVEL_INDOOR);
	SPAWN_WENTEKO(1186.f, 200.f, 333.f, LEVEL_INDOOR);
	SPAWN_WENTEKO(1186.f, 200.f, 333.f, LEVEL_INDOOR);

	SPAWN_SHOTGUNNER(826.f, 200.f, 604.f, LEVEL_INDOOR);
	SPAWN_SHOTGUNNER(826.f, 200.f, 604.f, LEVEL_INDOOR);
	SPAWN_NUKEMUTANT(826.f, 200.f, 604.f, LEVEL_INDOOR);
	SPAWN_NUKEMUTANT(826.f, 200.f, 604.f, LEVEL_INDOOR);
	SPAWN_MECHSECT(1633.f, 200.f, 440.f, LEVEL_INDOOR);
	SPAWN_MECHSECT(1633.f, 200.f, 440.f, LEVEL_INDOOR);
	
	SPAWN_WENTEKO(2111.f, 200.f, 470.f, LEVEL_INDOOR);
	SPAWN_WENTEKO(2111.f, 200.f, 470.f, LEVEL_INDOOR);
