...
HRESULT CLevel_OutDoor::Ready_Layer_Monster(const _wstring& strLayerTag)
{
	...
	SPAWN_SHOTGUNNER(1045.f, 440.f, 344.f, LEVEL_OUTDOOR, false);
	
	SPAWN_GREATER(1281.f, 730.f, -173.f, LEVEL_OUTDOOR, true);
	SPAWN_GREATER(1517.f, 530.f, 692.f, LEVEL_OUTDOOR, true);
	SPAWN_GREATER(1201.f, 430.f, 986.f, LEVEL_OUTDOOR, false);
	
	SPAWN_CULTIST(804.f, 430.f, 1217.f, LEVEL_OUTDOOR, false);
	...
	SPAWN_GREATER(1795.f, 810.f, 330.f, LEVEL_OUTDOOR, true);

	SPAWN_CULTIST(1028.f, 760.f, 45.f, LEVEL_OUTDOOR, true);

	SPAWN_CULTIST(1477.f, 610.f, 937.f, LEVEL_OUTDOOR, true);
	SPAWN_CULTIST(1290.f, 610.f, 1260.f, LEVEL_OUTDOOR, true);

	SPAWN_MECHSECT(1550.f, 610.f, 1100.f, LEVEL_OUTDOOR, false);
	SPAWN_MECHSECT(1550.f, 610.f, 1030.f, LEVEL_OUTDOOR, false);

	SPAWN_MECHSECT(1300.f, 410.f, 830.f, LEVEL_OUTDOOR, false);
	SPAWN_MECHSECT(1080.f, 410.f, 956.f, LEVEL_OUTDOOR, false);
	SPAWN_MECHSECT(675.f, 410.f, 1080.f, LEVEL_OUTDOOR, false);
	SPAWN_MECHSECT(700.f, 410.f, 1330.f, LEVEL_OUTDOOR, false);

	SPAWN_MECHSECT(1260.f, 410.f, 1620.f, LEVEL_OUTDOOR, false);
	SPAWN_MECHSECT(1320.f, 410.f, 1680.f, LEVEL_OUTDOOR, false);
	SPAWN_MECHSECT(1250.f, 410.f, 1780.f, LEVEL_OUTDOOR, false);
	SPAWN_MECHSECT(1100.f, 410.f, 1620.f, LEVEL_OUTDOOR, false);
	SPAWN_MECHSECT(1000.f, 410.f, 1680.f, LEVEL_OUTDOOR, false);
	SPAWN_MECHSECT(1060.f, 410.f, 1800.f, LEVEL_OUTDOOR, false);
