...
CJumpAttack::CJumpAttack(LPDIRECT3DDEVICE9 pGraphicDev, wstring _strObjName)
	:CPSystem(pGraphicDev, _strObjName)
{
}

CJumpAttack::CJumpAttack(const CPSystem& Prototype)
	: CPSystem(Prototype)
{
}

HRESULT CJumpAttack::Initialize(void* pArg)
{
...
HRESULT CJumpAttack::Ready_Particle()
{
...
HRESULT CJumpAttack::Ready_Components(void* pArg)
{
...
void CJumpAttack::resetParticle(Attribute* attribute)
{
...
CJumpAttack* CJumpAttack::Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring _strObjName)
{
	CJumpAttack* pInstance = new CJumpAttack(pGraphicDev, _strObjName);
...
float CJumpAttack::GetRandomColor(float lowBound, float highBound)
{
...
CGameObject* CJumpAttack::Clone(void* pArg)
{
	CJumpAttack* pInstance = new CJumpAttack(*this);
	pInstance->m_isClone = true;

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Created : CJumpAttack");
