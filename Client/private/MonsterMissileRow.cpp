...
CMonsterMissileRow::CMonsterMissileRow(LPDIRECT3DDEVICE9 pGraphicDev, wstring _strObjName)
	:CPSystem(pGraphicDev, _strObjName)
{
}

CMonsterMissileRow::CMonsterMissileRow(const CPSystem& Prototype)
	: CPSystem(Prototype)
{
}

HRESULT CMonsterMissileRow::Initialize(void* pArg)
{
...
HRESULT CMonsterMissileRow::Ready_Particle()
{
...
HRESULT CMonsterMissileRow::Ready_Components(void* pArg)
{
...
void CMonsterMissileRow::resetParticle(Attribute* attribute)
{
	...
	attribute->_Animation = GetRandomFloat(0.f, 5.f);

	if (attribute->_isInitialized >= 2)
		attribute->_isAlive = false;
}

EVENT CMonsterMissileRow::Update(_float timeDelta)
{
...
HRESULT CMonsterMissileRow::Render()
{
...
CMonsterMissileRow* CMonsterMissileRow::Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring _strObjName)
{
	CMonsterMissileRow* pInstance = new CMonsterMissileRow(pGraphicDev, _strObjName);
...
float CMonsterMissileRow::GetRandomColor(float lowBound, float highBound)
{
...
void CMonsterMissileRow::SetPosition(_float3 Position)
{
	m_vPosition = Position;
}

CGameObject* CMonsterMissileRow::Clone(void* pArg)
{
	CMonsterMissileRow* pInstance = new CMonsterMissileRow(*this);
	pInstance->m_isClone = true;

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Created : CMonsterMissileRow");
