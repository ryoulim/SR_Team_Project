...
namespace Client
{
	...
	enum COLLIDER_GROUP { CG_PAWN, CG_MONSTER, CG_BOSS, CG_BLOCK, CG_INTERACTIVE, CG_ITEM, CG_PBULLET, CG_MBULLET, CG_TRIGGER, CG_END };
	...
	enum COLLIDER_ID {
		...
		CI_INTERACTIVE_LAVA, CI_INTERACTIVE_LADDER, CI_INTERACTIVE_PICTURE, CI_INTERACTIVE_SECURITY,
		CI_INTERACTIVE_END,
