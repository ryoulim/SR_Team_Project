...
#pragma endregion
	...
	virtual void Exit() override
	{
		m_pOwner->Set_State(CRaceBoss::DRAWINGBOMBRADIUS);
	}
private:
...
class CRBState_DrawingBombRadius final : public CRBState
{
public:
	CRBState_DrawingBombRadius(CRaceBoss* pOwner)
		:CRBState(pOwner) {}
	virtual ~CRBState_DrawingBombRadius() = default;
