...
Cultist_iDesc.fMaxDistanceFromSelf = 400.f;					\
_float3 Pos = { x, y, z };									\
...
Shotgunner_iDesc.fMaxDistanceFromSelf = 250.f;				\
_float3 Pos = { x, y, z };									\
...
Greater_iDesc.fMaxDistanceFromSelf = 400.f;					\
_float3 Pos = { x, y, z };									\
...
Wenteko_iDesc.fMaxDistanceFromSelf = 25.f;					\
_float3 Pos = { x, y, z };									\
...
Nukemutant_iDesc.fMaxDistanceFromSelf = 150.f;				\
_float3 Pos = { x, y, z };									\
...
Mechsect_iDesc.fMaxDistanceFromSelf = 100.f;				\
_float3 Pos = { x, y, z };									\
...
Archangel_iDesc.fMaxDistanceFromSelf = 100.f;				\
_float3 Pos = { x, y, z };									\
